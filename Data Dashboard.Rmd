...
This interactive graph is showing the percentage changes of the price index for beef and veal, eggs and pork from the years 2000 to 2010. 

``` {r interactive line graph, echo=FALSE, message=FALSE}
